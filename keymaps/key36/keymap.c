...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [_QWERTY] = LAYOUT(
    ...
    [_NUL] = LAYOUT(
      ...
      _______ , _______ , KC_6    , KC_5    , KC_4    , _______ , _______ ,        _______ , KC_PGUP , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , _______, 
      _______ , _______ , KC_3    , KC_2    , KC_1    , KC_0    , _______ ,        _______ , KC_PGDN , KC_HOME , KC_DEL  , KC_END  , KC_PGDN , _______, 
    ...
    [_SYM] = LAYOUT(
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ , _______ , _______ , _______ , _______ , _______ , _______, 
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ , KC_LBRC , KC_RBRC , KC_LPRN , KC_RPRN , KC_BSLS , _______, 
    ...
    [_NVR] = LAYOUT(
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______ , _______ , _______ , _______ , _______ , _______ , _______, 
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______ , KC_EQL  , KC_MINS , KC_UP   , _______ , KC_BSPC , _______, 
    ...
    [_MO] = LAYOUT(
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______ , _______ , _______ , _______ , _______ , _______ , _______ , 
      _______ , KC_WH_L , KC_WH_R , KC_WH_U , _______ , KC_WH_U , _______ ,         _______ , KC_WH_U , _______ , KC_MS_U , KC_WH_L , KC_WH_R , _______ , 
      _______ , _______ , KC_MS_L , KC_MS_D , KC_MS_R , KC_WH_D , _______ ,         _______ , KC_WH_D , KC_MS_L , KC_MS_D , KC_MS_R , _______ , _______ , 
      _______ , _______ , KC_BTN4 , KC_BTN2 , KC_BTN1 , KC_BTN3 , _______ ,         _______ , KC_BTN3 , KC_BTN1 , KC_BTN2 , KC_BTN4 , _______ , _______ , 
      _______ , _______ , _______ , _______ ,           _______ , _______ ,         _______ , _______ ,           _______ , _______ , _______ , _______  )
