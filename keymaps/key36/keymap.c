...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [_QWERTY] = LAYOUT(
    ...
    [_NUL] = LAYOUT(
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ , _______ , _______ , _______ , _______ , _______ , _______, 
      _______ , KC_F12  , KC_F11  , KC_F10  , KC_F6   , KC_F5   , _______ ,        _______ , _______ , _______ , _______ , _______ , _______ , _______, 
      _______ , KC_9    , KC_8    , KC_7    , KC_6    , KC_5    , _______ ,        _______ , KC_PGUP , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , _______, 
      _______ , KC_4    , KC_3    , KC_2    , KC_1    , KC_0    , _______ ,        _______ , KC_PGDN , KC_HOME , KC_DEL  , KC_END  , KC_PGDN , _______, 
      _______ , _______ , _______ , _______ ,           _______ , _______ ,        _______ , _______ ,           _______ , _______ , _______ , _______ ),   
    [_SYM] = LAYOUT(
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ , _______ , _______ , _______ , _______ , _______ , _______, 
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ , KC_LPRN , KC_RPRN , KC_LBRC , KC_RBRC , KC_BSLS , _______, 
    ...
    [_NVR] = LAYOUT(
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______ , _______ , _______ , _______ , _______ , _______ , _______, 
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______ , _______ , _______ , KC_UP   , _______ , KC_BSPC , _______, 
